...
contract SimpleProjectRegistry is ReentrancyGuard, Ownable {
    ...
    function createProject(
        ...
        require(
            ...
            "Not a participant in this hackathon"
        );
        ...
        projectExists(projectId)
    {
        ...
        require(
            hackathon.isParticipant(member),
            "Member not a participant in this hackathon"
        );
    ...
    ) external onlyProjectCreator(projectId) projectExists(projectId) {
    ...
    function getProject(
        uint256 projectId
    ) external view projectExists(projectId) returns (Project memory project) {
    ...
    function getTeamMembers(
        uint256 projectId
    ) external view projectExists(projectId) returns (address[] memory) {
