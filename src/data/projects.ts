...
export const mockProjects: Project[] = [
  {
    ...
    name: "Init Club Pro",
    description:
      "Init Club Pro was born from a simple but radical belief: true innovation shouldn't be slowed by legacy processes or outdated infrastructure. Built for the next generation of developers.",
    fullDescription:
      "Init Club Pro is an innovative platform designed to accelerate developer innovation. Leveraging modern infra, it combines GameFi, SocialFi, and NFT-like engagement features such as AI-generated quizzes, live auctions, and leaderboards.",
  ...
  },
  {
    ...
    name: "Ward",
    description:
      "Ward was born from a simple but radical belief: true innovation shouldn't be constrained by traditional boundaries. A revolutionary platform for modern healthcare management.",
    hackathonId: "hackathon-1", // AI Revolution 2025
  ...
  },
  {
    ...
    name: "Wiral",
    description:
      "Wiral was born from a simple but radical belief: true innovation shouldn't be limited by conventional wireless technology. Next-gen connectivity solution for IoT devices.",
    hackathonId: "hackathon-1", // AI Revolution 2025
  ...
  },
  {
    ...
    name: "EcoTrack AI",
    description:
      "An intelligent environmental monitoring system that uses AI to track carbon emissions and suggest optimization strategies for businesses and individuals.",
  ...
  },
  {
    ...
    description:
      "Smart contract protocol that automatically optimizes yield farming strategies across multiple DeFi platforms while minimizing gas fees and impermanent loss.",
  ...
  },
  {
    ...
    name: "MedAssist AR",
    description:
      "Augmented reality application for medical professionals to visualize patient data, medical imaging, and treatment protocols in real-time during procedures.",
...
export function getSubmittedProjectsByHackathon(
  hackathonId: string,
): Project[] {
