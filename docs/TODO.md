...
### Story 1.1: HackathonFactory.sol - Factory Contract (8 points)
**Description**: Main factory contract for creating hackathons
**Tasks**:
- [ ] Implement `createHackathon()` function with access control
- [ ] Add organizer role management and permissions
- [ ] Event emission for hackathon creation lifecycle
- [ ] IPFS metadata integration for hackathon details
- [ ] Gas optimization for factory operations
- [ ] Owner/admin functionality for global settings

**Acceptance Criteria**:
- [ ] Organizers can create new hackathons
- [ ] Each hackathon gets unique address and ID
- [ ] Factory maintains registry of all hackathons
- [ ] Events emitted for indexing and frontend updates

### Story 1.2: Hackathon.sol - Individual Event Management (10 points)
**Description**: Individual hackathon contract with comprehensive event management
**Tasks**:
- [ ] Registration period management with time controls
- [ ] Phase transitions (registration → hackathon → judging → results)
- [ ] Participant registration logic with wallet verification
...
1. **HackathonFactory** → Creates **Hackathon** instances
2. **Hackathon** → Integrates with **ProjectRegistry**, **JudgeRegistry**, **PrizePool**
...
1. HackathonFactory (foundation contract)
2. Hackathon (core event logic) 
